                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#edit<?=$idbk;?>"> Edit
                                            </button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#delete<?=$idbk;?>"> Delete
                                            </button>
                                        </td>
                                    </tr>

                                    <!-- The Modal Edit -->
                                    <div class="modal fade" id="edit<?=$idbk;?>">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input class="form-control" name="jumlah" type="number"
                                                                placeholder="Jumlah" value="<?=$jumlah;?>" required>
                                                            <label>Jumlah</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input class="form-control" name="pembeli" type="text"
                                                                placeholder="Pembeli" value="<?=$pembeli;?>" required>
                                                            <label>Pembeli</label>
                                                        </div>
                                                        <br>
                                    ...
                                    <!-- The Modal Delete -->
                                    <div class="modal fade" id="delete<?=$idbk;?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST">
                    <div class="modal-body">
                        <label>Produk</label>
                        <select name="jenisnya" id="jenisnya" class="form-control">
                            <?php
                ...
                ?>
                        ...
                        <br>
                        <div class="form-floating mb-3">
                            <input class="form-control" name="jumlah" id="jumlah" type="number" placeholder="Jumlah"
                                required>
                            <label>Jumlah</label>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" name="pembeli" type="text" placeholder="Pembeli" required>
                            <label>Pembeli</label>
                        </div>
                        <br>
                        <div class="modal-footer">
